...
<html lang="en">
    ...
    <img id="logo" src="Logo.png">
        ...
        <title>Search for a job seeker according to gender</title>
    </head>
    <body>
        <?php 
            $name="";
        ...
        <form method="get">
       <h1>Search for a job seeker according to gender</h1> 
            
            <input class="sb" type='text' name="gender" value="<?php echo $name;?>">
            </br>
            </br>
