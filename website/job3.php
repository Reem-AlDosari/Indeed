...
<html lang="en">
    ...
    <img id="logo" src="Logo.png">
        ...
        <title>Search for a job according to position</title>
    ...
    <body>
        ...
        <form method="get">
        <h1>Search for a job according to position</h1>
           
            <input class="sb" type='text' name="position" value="<?php echo $name;?>">
            </br>
            </br>
