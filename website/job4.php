...
<html lang="en">
    ...
    <img id="logo" src="Logo.png">
        ...
        <title>Search for a job  according to full time / part time</title>
    ...
    <body>
        <?php 
            ...
            if(isset($_GET['fulltimeparttime']))
            $name = $_GET['fulltimeparttime'];
        ?>
        
        <form method="get">
        <h1>Search for a job  according to full time / part time</h1>
           
            <input class="sb"  type='text' name="fulltimeparttime" value="<?php echo $name;?>">
            </br>
            </br>
        ...
        <?php
            if(isset($_GET['fulltimeparttime'])) {
                $sql = "SELECT* FROM job
                    where `full time/part time`='" .$_GET['fulltimeparttime']. "'";
