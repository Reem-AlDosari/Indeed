...
<html lang="en">
    ...
    <img id="logo" src="Logo.png">
        ...
        <title>Search for a job seeker according to nationality</title>
    </head>
    <body>
        <?php 
            $name="";
        ...
        <form method="get">
       <h1>Search for a job seeker according to nationality</h1> 
           
            <input class="sb" type='text' name="nationality" value="<?php echo $name;?>">
            </br>
            </br>
