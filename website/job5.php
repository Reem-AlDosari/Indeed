...
<html lang="en">
    ...
    <img id="logo" src="Logo.png">
        ...
        <title>Search for a job  according to company name</title>
    ...
    <body>
        ...
        <form method="get">
        <h1>Search for a job  according to company name</h1>
           
            <input class="sb" type='text' name="id" value="<?php echo $name;?>">
            </br>
            </br>
        ...
        <table >
            ...
            //fetches a result row as an associative array
                while($row = mysqli_fetch_assoc($result))
                    ...
                    <td>'.$row['salary'].'</td><td>'.$row['comanyname'].'</td>
