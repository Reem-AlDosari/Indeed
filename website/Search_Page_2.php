...
<div class="sidebar">
            ...
            <h1 class=titlead> Job Search </h1>
            </div>
            
                      <div class="container">
<button ><a  class="lab" href="job2.php">City</a></button>
<button ><a  class="lab" href="job1.php">major</a></button>
<button><a  class="lab" href="job3.php">position</a></button>
<button ><a   class="lab" href="job5.php">company</a></button>
<button ><a  class="lab" href="job4.php">time</a></button>
            </div>
